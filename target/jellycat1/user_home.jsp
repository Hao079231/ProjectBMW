    ...
    <header class="border-b">
        <div class="container mx-auto flex justify-between items-center py-4 px-6">
            ...
            <div class="flex items-center space-x-6">
                <%
                    String profileLink = session.getAttribute("user") != null ? "profile.jsp" : "SignInUp";
                %>
                <a href="<%= profileLink %>">
        ...
        <div class="container mx-auto flex items-center justify-between py-3">
            <div class="relative">
                ...
                <div id="dropdown"
                    ...
                    %>
                        <span class="block px-4 py-2 text-gray-600">No categories available</span>
                    <%
                        }
                    %>
                </div>
            ...
            %>
                <div class="product-card p-4 bg-white rounded shadow-md relative group">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <p class="text-green-600 font-semibold">Giá: <%= product.getPrice() %> VND</p>
