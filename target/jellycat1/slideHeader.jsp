...
<body class="font-roboto">
    ...
    <div class="relative w-full max-w-6xl mx-auto mt-12 overflow-hidden">
        ...
        <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
            <button onclick="navigateSlide(0)" class="w-3 h-3 rounded-full bg-gray-300"></button>
            <button onclick="navigateSlide(1)" class="w-3 h-3 rounded-full bg-gray-300"></button>
            <button onclick="navigateSlide(2)" class="w-3 h-3 rounded-full bg-gray-300"></button>
        </div>
