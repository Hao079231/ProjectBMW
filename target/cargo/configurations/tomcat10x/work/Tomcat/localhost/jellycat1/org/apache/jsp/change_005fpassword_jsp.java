 ...
 * Generated at: 2025-05-25 13:25:14 UTC
...
public final class change_005fpassword_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <h3>Đổi mật khẩu mới</h3>\r\n");
      out.write("              </div>\r\n");
 ...
 session.removeAttribute("message"); } 
      ...
      out.write("                      <label for=\"password\" class=\"form-label\">Mật khẩu mới:</label>\r\n");
      out.write("                      <input type=\"password\" class=\"form-control\" id=\"password\" name=\"password\" required minlength=\"8\"\r\n");
      out.write("                        pattern=\"^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&])[A-Za-z\\d@$!%*?&]{8,}$\">\r\n");
      out.write("                      <div class=\"invalid-feedback\">\r\n");
      out.write("                        Mật khẩu không đáp ứng yêu cầu.\r\n");
      out.write("                      </div>\r\n");
      out.write("                      <div class=\"password-requirements\">\r\n");
      out.write("                        Mật khẩu phải có:\r\n");
      out.write("                        <ul>\r\n");
      out.write("                          <li id=\"length\">Ít nhất 8 ký tự</li>\r\n");
      out.write("                          <li id=\"uppercase\">Ít nhất 1 chữ in hoa</li>\r\n");
      out.write("                          <li id=\"lowercase\">Ít nhất 1 chữ thường</li>\r\n");
      out.write("                          <li id=\"number\">Ít nhất 1 số</li>\r\n");
      out.write("                          <li id=\"special\">Ít nhất 1 ký tự đặc biệt (@$!%*?&)</li>\r\n");
      out.write("                        </ul>\r\n");
      out.write("                      </div>\r\n");
      out.write("                    </div>\r\n");
      out.write("                    <div class=\"form-group mb-3\">\r\n");
      out.write("                      <label for=\"confirm_password\" class=\"form-label\">Xác nhận mật khẩu:</label>\r\n");
      out.write("                      <input type=\"password\" class=\"form-control\" id=\"confirm_password\" name=\"confirm_password\"\r\n");
      out.write("                        required>\r\n");
      out.write("                      <div class=\"invalid-feedback\">\r\n");
      out.write("                        Mật khẩu xác nhận không khớp.\r\n");
      out.write("                      </div>\r\n");
      out.write("                    </div>\r\n");
      out.write("                    <div class=\"d-grid gap-2\">\r\n");
      out.write("                      <button type=\"submit\" class=\"btn btn-primary\" id=\"submitBtn\" disabled>Đổi mật khẩu</button>\r\n");
      out.write("                      <a href=\"signinup.jsp\" class=\"btn btn-outline-primary\">Quay lại đăng nhập</a>\r\n");
      out.write("                    </div>\r\n");
      out.write("                  </form>\r\n");
      out.write("              </div>\r\n");
      out.write("            </div>\r\n");
      ...
      out.write("          const confirmPassword = document.getElementById('confirm_password');\r\n");
      out.write("          const submitBtn = document.getElementById('submitBtn');\r\n");
      out.write("          const requirements = {\r\n");
      out.write("            length: /.{8,}/,\r\n");
      out.write("            uppercase: /[A-Z]/,\r\n");
      out.write("            lowercase: /[a-z]/,\r\n");
      out.write("            number: /[0-9]/,\r\n");
      out.write("            special: /[@$!%*?&]/\r\n");
      out.write("          };\r\n");
      out.write("\r\n");
      out.write("          function validatePassword() {\r\n");
      out.write("            const pwd = password.value;\r\n");
      out.write("            let valid = true;\r\n");
      out.write("\r\n");
      out.write("            // Check each requirement\r\n");
      out.write("            for (let req in requirements) {\r\n");
      out.write("              const element = document.getElementById(req);\r\n");
      out.write("              if (requirements[req].test(pwd)) {\r\n");
      out.write("                element.classList.add('requirement-met');\r\n");
      out.write("                element.classList.remove('requirement-not-met');\r\n");
      out.write("              } else {\r\n");
      out.write("                element.classList.add('requirement-not-met');\r\n");
      out.write("                element.classList.remove('requirement-met');\r\n");
      out.write("                valid = false;\r\n");
      out.write("              }\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            // Check if passwords match\r\n");
      out.write("            if (pwd === confirmPassword.value && pwd !== '') {\r\n");
      out.write("              confirmPassword.setCustomValidity('');\r\n");
      out.write("            } else {\r\n");
      out.write("              confirmPassword.setCustomValidity('Mật khẩu không khớp');\r\n");
      out.write("              valid = false;\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            submitBtn.disabled = !valid;\r\n");
      out.write("            return valid;\r\n");
      out.write("          }\r\n");
      out.write("\r\n");
      out.write("          password.addEventListener('input', validatePassword);\r\n");
      out.write("          confirmPassword.addEventListener('input', validatePassword);\r\n");
      out.write("\r\n");
      ...
      out.write("                  if (!form.checkValidity() || !validatePassword()) {\r\n");
