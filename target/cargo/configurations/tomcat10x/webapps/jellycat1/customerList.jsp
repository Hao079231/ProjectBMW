...
<body class="bg-gray-100">
            ...
            <div class="flex justify-between">
                <div class="flex space-x-4">
                    ...
                    <div class="hidden md:flex items-center space-x-1">
                        ...
                        <a class="block py-2 px-4 text-sm" href="Category" id="nav-category">Category</a>
                    </div>
                </div>
                <!-- Secondary Nav -->
                <div class="hidden md:flex items-center space-x-1">
    ...
    <div class="max-w-7xl mx-auto px-4 py-6" id="main-content">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="customer-list">
            ...
            <%
                List<Users> usersList = (List<Users>) request.getAttribute("usersList"); // Lấy danh sách người dùng
                if (usersList != null) {
                    for (Users user : usersList) { // Duyệt qua danh sách người dùng
            %>
                        <div class="bg-white p-6 rounded-lg shadow-lg">
                            <h2 class="text-xl font-bold mb-2"><%= user.getUsername() %></h2>
                            <p class="text-gray-700 mb-4">Email: <%= user.getEmail() %></p>
                            <p class="text-gray-700 mb-4">Phone: <%= user.getPhone() %></p>
                            <p class="text-gray-700 mb-4">Address: <%= user.getAddress() %></p>
                        </div>
            <%
                    }
                }
