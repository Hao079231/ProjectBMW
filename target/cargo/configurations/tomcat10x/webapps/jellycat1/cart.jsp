          ...
          <% } %>
                  ...
                  <div
                      ...
                      <div class="logo flex items-center">
                          <img alt="Jellycat logo" class="mr-4" height="50"
                              ...
                              width="50">
                          <span
                              class="text-2xl font-bold text-blue-500">JELLYCAT</span>
                      </div>
              ...
              <div class="container mx-auto py-8">
                  ...
                  if (cart !=null && !cart.isEmpty()) { %>
                                  ...
                                  <tr>
                                      ...
                                      <td class="py-2 px-4 border-b">
                                          <form action="CartServlet" method="post"
                                              ...
                                              <button type="submit"
                                                  class="ml-2 bg-blue-600 text-white rounded px-2 py-1">Update</button>
                                          </form>
                                      </td>
                                      <td class="py-2 px-4 border-b">
                                          <%= item.getTotal() %> VND
                                      ...
                                      <td class="py-2 px-4 border-b">
                                          <form action="CartServlet" method="post"
                                              ...
                                              <input type="hidden" name="productId"
                                                  value="<%= productId %>" />
                                              <button type="submit"
                                                  class="bg-red-600 text-white rounded px-2 py-1">Remove</button>
                                          </form>
                                      </td>
                                  </tr>
                                  <% } %>
                      ...
                      <div class="mt-4">
                          <h2 class="text-xl font-bold">Total Amount: <%=
                                  cart.getTotalPrice() %> VND</h2>
                      </div>

                      <div class="mt-4">
                          <a href="ProductList"
                              class="bg-green-600 text-white rounded px-4 py-2">TIẾP
                              TỤC MUA SẮM</a>
                          <a href="checkout.jsp"
                              class="bg-blue-600 text-white rounded px-4 py-2 ml-2">ĐẶT
                              HÀNG</a>
                      </div>
