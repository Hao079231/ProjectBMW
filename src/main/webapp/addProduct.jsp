        ...
        <form id="productForm" class="flex flex-col md:flex-row" action="Product" method="post"
            ...
            <div class="md:w-1/2 md:pr-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="product-size" name="size"
                        class="w-full p-2 border border-gray-300 rounded" placeholder="Nhập kích cỡ"
                        required>
                </div>
                <div class="mb-4">
                ...
                <button type="submit" class="w-full bg-orange-500 text-white py-2 rounded">Thêm Sản
                    Phẩm</button>
            </div>
            ...
            <div class="md:w-1/2 md:pl-4 flex flex-col items-center">
                ...
                <div
                    ...
                    <img id="image-preview" class="max-h-full max-w-full" src="#" alt="Image Preview"
                        style="display: none;">
                </div>
            </div>
        </form>
