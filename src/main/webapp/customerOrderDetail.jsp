                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"
                                ...
                                <% List<OrderItem> orderItems = (List<OrderItem>)
                                        ...
                                        <div class="bg-white p-6 rounded-lg shadow-lg">
                                            ...
                                            <h3 class="text-xl font-bold mb-2">Sản phẩm: <%=
                                                    item.getProductName() %>
                                            </h3>
                                            <p class="text-gray-700 mb-4">Số lượng: <%=
                                                    item.getQuantity() %>
                                            </p>
                                            <p class="text-gray-700 mb-4">Giá: <%= item.getPrice()
                                                    %>
                                            </p>
                                            <p class="text-gray-700 mb-4">Tổng: <%=
                                                    item.getQuantity() * item.getPrice() %>
                                            </p>

                                            <!-- Thêm nút Đánh giá, căn chỉnh qua góc phải -->
                                            <form action="Review" method="post"
                                                ...
                                                <button type="submit"
                                                    class="mt-4 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700">Đánh
                                                    giá</button>
                                            </form>
                                        </div>
                                        <% } } %>
