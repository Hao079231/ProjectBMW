...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        <h1 class="text-3xl font-bold mb-6">Sửa Danh Mục</h1>
        <%
        ...
        <form action="Category" method="post" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" id="cname" name="cname" value="<%= category.getCname() %>" required
                       class="w-full p-2 border border-gray-300 rounded">
            </div>
            <button type="submit" class="w-full bg-orange-500 text-white py-2 rounded hover:bg-orange-600">Cập Nhật</button>
