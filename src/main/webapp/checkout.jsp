    ...
    <header class="bg-white shadow-lg">
        <div class="container mx-auto flex justify-between items-center py-4 px-6">
            <div class="logo flex items-center">
                <img alt="Logo" class="mr-4" height="50" src="https://storage.googleapis.com/a1aa/image/FQHw3eMxpk2eakMv3O1MJ3DrSguzwJk8FAGfLnYFr6mlCFlnA.jpg" width="50">
            ...
            <div class="flex items-center space-x-6">
                ...
                <a href="Cart" class="text-gray-600 hover:text-blue-500">Cart</a>
            </div>
        </div>
    </header>
...
%>
        ...
        <div class="mt-4">
            <h2 class="text-xl font-bold">Tổng: <%= cart.getTotalPrice() %> VND</h2>
        </div>
